...
describe("createPress", () => {
  ...
  describe("mouse events", () => {
    it("should fire press events based on mouse events", async () => {
      const events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should fire press change events when moving mouse outside target", async () => {
      let events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should not focus the element on click if preventFocusOnPress is true", async () => {
      render(() => <Example preventFocusOnPress />);
    ...
    it("should focus the element on click by default", async () => {
      render(() => <Example />);
    ...
    it("should prevent default on mousedown by default", async () => {
      render(() => <Example />);

      const el = screen.getByText("test");

      const allowDefault = fireEvent.mouseDown(el);
      await Promise.resolve();
  ...
  describe("touch events", () => {
    it("should fire press events based on touch events", async () => {
      const events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should fire press change events when moving touch outside target", async () => {
      let events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should cancel press after scroll events", async () => {
      const events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should not cancel press after scroll events in unrelated scrollable regions", async () => {
      const events: any[] = [];
      const addEvent = (e: any) => events.push(e);
    ...
    it("should focus the target on touch by default", async () => {
      render(() => <Example />);
    ...
    it("should fire press event when touchup close to the target", async () => {
      const spy = jest.fn();
      render(() => <Example onPress={spy} />);
